...
- Available: `pd`, `np`, `scipy`, `sklearn`
- No matplotlib — use computer tool for charts
...
**Charts**: For time-series, create continuous day index (no weekend gaps), set x-axis ticks manually.
